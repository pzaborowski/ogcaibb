...
**Status**: stable · **Scope**: generic in concept · **Building-block coupling**: none (uses SKOS / DCAT vocabularies, not a specific bblock).  
_Annotates Turtle for VocPrez / Prez rendering._
