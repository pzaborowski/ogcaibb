...
**Status**: pre-release · **Scope**: generic in concept · **Building-block coupling**: depends on the `ogc.hosted.seadots.odd-protocol` bblock.  
_Output instances conform to one specific bblock._
