...
**Status**: pre-release · **Scope**: generic in concept · **Building-block coupling**: depends on the OIM profile bblocks (`oim`, `oim-obs`, `oim-bio-tdwg`).  
_Output targets specific OIM-enriched JSON-FG profiles._
