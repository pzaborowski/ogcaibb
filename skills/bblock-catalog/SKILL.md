...
**Status**: pre-release · **Scope**: generic · **Building-block coupling**: none — reads `bblocks-config.yaml` + imported registers.  
_Inventory + classification + (optional) embedding-coordinate lookup._
